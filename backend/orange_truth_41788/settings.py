"""
Django settings for orange_truth_41788 project.
...
ROOT_URLCONF = 'orange_truth_41788.urls'
...
WSGI_APPLICATION = 'orange_truth_41788.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "orange_truth_41788 API",
    "DESCRIPTION": "API documentation for orange_truth_41788 App",
    "VERSION": "v1",
}
